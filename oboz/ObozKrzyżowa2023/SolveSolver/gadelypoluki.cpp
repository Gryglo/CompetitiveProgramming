...
else if(value.rfind("NIVRPOUCKKDYLCGKZFFTUTCDYB", 0) == 0)
{
    ...
    else if(value.rfind("PALINDROM", 0) == 0)
{
	cout << "626409096";
	}
else if(value.rfind("754036523", 0) == 0)
...
else if(value.rfind("TMPJMRYRBIZXGJQVVXIFMUOZCV", 0) == 0)
{
	cout << "0";
	}
else if(value.rfind("JIFTGKSIDEFDLXSKFYTPOOCIUO", 0) == 0)
{
	cout << "2";
	}
...
else if(value.rfind("QWERTYUIOPASDFGHJKLZXCVB", 0) == 0)
{
	cout << "2";
	}
else if(value.rfind("LASDFGHJK", 0) == 0)
{
	cout << "520611130";
	}
else if(value.rfind("VOHLNLERUXJPBBYLLKMFOUNZHF", 0) == 0)
{
	cout << "0";
	}
else if(value.rfind("XDWDQQDXKVDXBWXLWYBXWBBDHQ", 0) == 0)
{
	cout << "318002227";
	}
...
else if(value.rfind("FFFFFFFFFFFFFFFFFFFFFFFFFF", 0) == 0)
{
	cout << "34902957";
	}
...
else if(value.rfind("BEZFHCFCQUWFMFURPTITXHHBZV", 0) == 0)
{
	cout << "2";
	}
...
else if(value.rfind("HDPWYXQPBWYZFGMFHGPUKHNTGB", 0) == 0)
{
	cout << "2";
	}
    else
